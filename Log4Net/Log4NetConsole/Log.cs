...
namespace Log4NetConsole
{
    public class Log
    {
        ...
        protected static ILog debuggingLogger;
        
        private Log()
        {
            monitoringLogger = LogManager.GetLogger("Monitoring");
            debuggingLogger = LogManager.GetLogger("Debugging");
        }
        ...
        {  
            debuggingLogger.Debug(message, exception);  
        }  
